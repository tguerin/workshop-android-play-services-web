...
App.MapView = Ember.View
		.extend({
			...
			didInsertElement : function() {
				...
				this
						.set('map', new google.maps.Map(document
								.getElementById('content-map'), this
								.get('mapOptions')));
				this._clearMap();
				...
				var fnOnMessage = function(evt) {
					...
					// + '<img data-src="holder.js/40x40" class="img-circle"
					// alt="140x140" style="width: 40px; height:
					// 40px;margin-right:5px;"
															...
															$
																	.ajax({
																		...
																		success : function(
																			...
																			self
																					.get('infoWindow').content = contentMarker;
																			infoWindow
																					.open(
																							map,
																							marker);
